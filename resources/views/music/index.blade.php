                    ...
                    <div class="row">
                            ...
                            <div class="music-wrapper">
                                <div class="image-header">
                                    <a href="{{ route('music-artist-band-dj-page') }}">
                                        <img src="{{asset('assets/img/music/music1.png')}}" />
                                    </a>
                                </div>
                                <div class="content">
                                    <h2>DJS</h2>
                        ...
                        <div class="music-card text-left col-md-4 mt-3 mb-4 pl-0">
                            <div class="music-wrapper">
                                <div class="image-header">
                                    <a href="{{ route('music-artist-band-dj-page') }}">
                                        <img src="{{asset('assets/img/music/music2.png')}}" />
                                    </a>
                                </div>
                                <div class="content">
                                    <h2>BANDS</h2>
                        ...
                        <div class="music-card text-left col-md-4 mt-3 mb-4 pl-0">
                            <div class="music-wrapper">
                                <div class="image-header">
                                    <a href="{{ route('music-artist-band-dj-page') }}">
                                        <img src="{{asset('assets/img/music/music3.png')}}" />
                                    </a>
                                </div>
                                <div class="content">
                                    <h2>ARTISTS</h2>
                            ...
                            <div class="music-wrapper">
                                <div class="image-header">
                                    <a href="{{ route('music-venues-page') }}">
                                        <img src="{{asset('assets/img/music/music4.png')}}" />
                                    </a>
                                </div>
                                <div class="content">
                                    <h2>VENUES</h2>
                        ...
                        <div class="music-card text-left col-md-4 mt-3 mb-4 pl-0">
                            <div class="music-wrapper">
                                <div class="image-header">
                                    <a href="{{ route('music-radio-page') }}">
                                        <img src="{{asset('assets/img/music/music5.png')}}" />
                                    </a>
                                </div>
                                <div class="content">
                                    <h2>RADIO</h2>
                        ...
                        <div class="music-card text-left col-md-4 mt-3 mb-4 pl-0">
                            <div class="music-wrapper">
                                <div class="image-header">
                                    <a href="{{ route('music-loop-entertainment-page') }}">
                                        <img src="{{asset('assets/img/music/music6.png')}}" />
                                    </a>
                                </div>
                                <div class="content">
