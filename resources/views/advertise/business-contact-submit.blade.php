        ...
        <main>
            ...
            <section class="business-form mt-4 mb-4">
                <h2 class="form-msg mb-4">
                    Thank you for you request! Please fill out this form and an East Bay Loop repyesentative
                    will get in touch with you within 24-28 hours.
                </h2>
                <form class="mt-3">
                    <div class="row m-0">
                        <div class="col-md-6 py-0 px-3 form-field mb-3">
                        ...
                        <div class="col-md-6 py-0 row m-0">
                            <div class="col-md-6 p-0 mb-3 form-field">
                                <label for="name">First Name*</label>
                                <input id="name" class="text-input" type="text" />
                            </div>
                            <div class="col-md-6 p-0 mb-3 form-field mb-3">
                        ...
                        <div class="col-md-6 py-0 px-3 form-field">
                            <label >I am interested in the following:</label>
                            <div class="row m-0">
                                <div class="col-md-6 py-0 mb-3">
                        ...
                        <div class="col-md-6 py-0 row m-0">
                            <div class="col-md-6 p-0 form-field mb-3">
                        ...
                        <div class="col-md-12 p-0 px-3 form-submit mb-3 mt-3">
