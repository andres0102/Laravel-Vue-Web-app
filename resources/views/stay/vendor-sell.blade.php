                            ...
                            <div class="music-card text-left col-md-4 mt-3 mb-4">
                                <div class="music-wrapper">
                                    <div class="image-header">
                                        <a href="{{ route('stay-profile-page', ['category' => $category_name]) }}">
                                            <img src="{{asset('assets/img/stay/stay'.$i.'.png')}}" />
                                        </a>
                                    </div>
                                    <div class="content">
                                        ...
                                        <a class="read-more-link" href="{{ route('stay-profile-page', ['category' => $category_name]) }}">Read More...</a>
                                    </div>
                                </div>
                            </div>
                        @endfor
