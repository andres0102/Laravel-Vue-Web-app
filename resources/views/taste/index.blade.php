                ...
                <div class="section-content container">
                    <div class="row">
                        <div class="taste-card text-center col-md-4 mt-3">
                            <div class="taste-wrapper">
                                <div class="image-header">
                                    <a href="{{ route('taste-place-show',['place_url'=>'restaurants']) }}">
                                ...
                                <div class="content">
                                    ...
                                    <a class="read-more-btn float-none taste-read-more" href="{{ route('taste-place-show',['place_url'=>'restaurants']) }}">READ MORE</a>
                                </div>
                            </div>
                        </div>
                        <div class="taste-card text-center col-md-4 mt-3">
                        ...
                        <div class="taste-card text-center col-md-4 mt-3">
                            <div class="taste-wrapper">
                                <div class="image-header">
                                    <a href="{{ route('taste-place-show',['place_url'=>'coffee-shops-bakeries']) }}">
                                        <img src="{{asset('assets/img/example/taste1.png')}}" />
                                ...
                                <div class="content">
                                    ...
                                    <a class="read-more-btn float-none taste-read-more" href="{{ route('taste-place-show',['place_url'=>'coffee-shops-bakeries']) }}">READ MORE</a>
                                </div>
                            </div>
                        </div>
                        <div class="taste-card text-center col-md-4 mt-3">
                        ...
                        <div class="taste-card text-center col-md-4 mt-3">
                            <div class="taste-wrapper">
                                <div class="image-header">
                                    <a href="{{ route('taste-place-show',['place_url'=>'food-trucks']) }}">
                                        <img src="{{asset('assets/img/example/taste3.png')}}" />
                                ...
                                <div class="content">
                                    ...
                                    <a class="read-more-btn float-none taste-read-more" href="{{ route('taste-place-show',['place_url'=>'food-trucks']) }}">READ MORE</a>
                                </div>
                            </div>
                        </div>
                    </div>
