...
Route::prefix('explore')->group(function(){
	Route::get('pamper', 'PamperController@index')->name('explore.pamper.index');
	Route::get('pamper/{id}', 'PamperController@pamperDetail')->name('explore.pamper.detail');

	Route::get('local-shops-shopping', 'LocalShopController@index')->name('explore.localshop.index');
	Route::get('localshop/{id}', 'LocalShopController@localshopDetail')->name('explore.localshop.detail');
});
Route::get('/explore', 'ExploreController@index')->name('explore-page');
Route::get('/explore/{type_url}/{category_url?}', 'ExploreController@showClients')->name('explore-subpage');
Route::get('/explore/{type_url}/show/{client_url}', 'ExploreController@showClient')->name('explore-show-client');
...
// Route::get('/explore/test/testme/asdsad/test1', 'ExploreController@test');
// Route::get('/explore/test/testme/asdsad/test2', 'ExploreController@test_en');
...
Route::get('/fashion/blog/{article_url}', 'FashionController@showSpotlightOn')->name('fashion-blog-article-page');
Route::get('/fashion/products', 'FashionController@showProducts')->name('fashion-product-page');
Route::get('/fashion/product', 'FashionController@showProducts')->name('fashion-per-product-page');
Route::get('/fashion/{category_url}/products', 'FashionController@showProducts')->name('fashion-display-products-page');
Route::get('/fashion/products/{sort}', 'FashionController@showSortProducts')->name('fashion-display-sort-products-page');
Route::get('/fashion/{category_url}/product/{product_url}', 'FashionController@showProduct')->name('fashion-display-product-page');
Route::get('/fashion/talents/', 'FashionController@showTalents')->name('fashion-display-talents-page');
Route::get('/fashion/talent/{talent_url}', 'FashionController@showOneTalent')->name('fashion-display-one-talent-page');
/*end fashion*/
/*market place */
...
Route::get('/market-place/retails/{company_url}', 'MarketPlaceController@showRetails')->name('market-place-retails-page');
Route::get('/market-place/products/{company_url}', 'MarketPlaceController@showProducts')->name('market-place-product-page');
Route::get('/market-place/product/{product_url}', 'MarketPlaceController@showProduct')->name('market-place-per-product-page');
/*end market palce */
...
Route::get("/taste/place/{place_url}",'TasteController@showPlaceCompanies')->name('taste-place-show');
Route::get('taste/place/company/{company_url}',"TasteController@showCompany")->name('taste-show-company');
Route::get('taste/place/restaurants}','TasteController@showRestaurants')->name('taste-restaurants-page');
...
//Bag routes
Route::get('/bag','Checkout\BagController@view')->name('view-bag');
